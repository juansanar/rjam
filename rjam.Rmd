...
I've started to merge my techy hobbies with my science and medicine curiosity. This led me to a path to learn `R` and this space (originally discussed during a lab meeting). So, basically `R` Jam Sessions is my little nook in the internet of things to develop my skills in data science and visualization using datasets from topics close to my research interests, others dear to my heart (hi homesickness? *how you doing?*), and some I've come across purely by chance.
